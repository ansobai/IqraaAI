...
def _pick_unique_verse_prefix(
    ...
    *,
    ...
    # Fallback: first long enough verse.
    for start, end in verse_spans:
        verse_words = page_words[start:end]
...
def test_google_mode_emits_delta_after_anchor_and_tracks_word_by_word():
    page_number = 1
    lexicon = load_page_lexicon(page_number)
    ...
    app = create_app(
        recognizer_mode_override="google",
...
def test_google_mode_continues_tracking_to_page_tail_and_past_word_64():
